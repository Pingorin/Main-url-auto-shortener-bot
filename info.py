...
BOT_TOKEN = environ.get('BOT_TOKEN', "8322496193:AAFhwFUZXv7zmIdoBrS75wcs8aBLJzsSYRU")
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '8345515768').split()]
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Bbjain12')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002879981715')).split()]
